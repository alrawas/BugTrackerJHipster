package com.alrawas.bugtracker.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.alrawas.bugtracker.service.EmailAlreadyUsedException ||
            ex instanceof com.alrawas.bugtracker.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.alrawas.bugtracker.service.InvalidPasswordException
